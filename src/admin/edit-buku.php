                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-buku.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input name="id_buku" type="text" id="id" class="form-control"  value="<?php echo $data['id_buku']; ?>" autofocus="on" readonly="readonly" />
                              </div>
                          </div>
                          <div class="form-group">
                                 ...
                                 <select class="form-control" name="kategori" id="kategori">
                                   <option>  <?php echo $data['kategori']; ?></option>
                                                    ...
                                                    while ($data2= mysql_fetch_array($sql2)) {
                                                        $ka = $data2['kode_kategori'];
                                                        $nama = $data2['nama_kategori'];
                                                        ?>
                                                        <option value="<?php echo $ka ?>"><?php echo $nama ?></option>
                                                    <?php } ?>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input name="th_terbit" class="form-control" id="th_terbit" type="text" value="<?php echo $data['th_terbit']; ?>" required />
                              </div>
                          </div>
						    <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <select class="form-control" name="penerbit" id="penerbit">
                                   <option>  <?php echo $data['penerbit']; ?></option>
                                                    <?php
                                                    $query3 = "SELECT * FROM penerbit order by penerbit";
                                                    $sql3 = mysql_query($query3);
                                                    while ($data3= mysql_fetch_array($sql3)) {
                                                        $ka2 = $data3['kode_penerbit'];
                                                        $nama2 = $data3['penerbit'];
                                                        ?>
                                                        <option value="<?php echo $ka2 ?>"><?php echo $nama2 ?></option>
                                                    <?php } ?>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input name="isbn" class="form-control" id="isbn" type="text" value="<?php echo $data['isbn']; ?>" required />
                              </div>
                          </div>
						   <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jumlah Buku</label>
                              <div class="col-sm-4">
                                  <input name="jumlah_buku" class="form-control" id="jumlah_buku" type="text" value="<?php echo $data['jumlah_buku']; ?>" required />
                              </div>
                          </div>
