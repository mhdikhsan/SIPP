                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-anggota.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="id_anggota" type="text" id="id_anggota" class="form-control"  value="<?php echo $data['id_anggota']; ?>" autofocus="on" readonly="readonly" />
                              </div>
                          </div>
                          <div class="form-group">
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  ...
                                  <option value="Dosen"> Dosesn</option>
                                  </select>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="masa_berlaku" class="form-control" id="masa_berlaku" type="text" value="<?php echo $data['masa_berlaku']; ?>" required />
                              </div>
                          </div>
						   <div class="form-group">
                          ...
                          <div class="form-group">
						   ...
						   <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input name="tgl_lahir" class="form-control" id="tgl_lahir" type="date" value="<?php echo $data['tgl_lahir']; ?>" required />
                              </div>
                          </div>
                          <div class="form-group">
