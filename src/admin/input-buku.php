                ...
                <section class="content">
                    ...
                    <div class="row">
					  ...
					  <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input name="id_buku" type="text" id="id" class="form-control" placeholder="BK" required autofocus="on"   />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
						   ...
						   <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input name="th_terbit" class="form-control" id="th_terbit" type="text" placeholder="Tahun" required />
                              </div>
                          </div>
						    <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <select class="form-control" name="penerbit" id="penerbit">
                                   <option value="" selected hidden>Pilih Penerbit</option>
                                                    <?php
                          ...
                          <div class="form-group">
						   ...
						   <div class="form-group">
                              ...
                              <div class="col-sm-4">
								<input type="text" class="form-control" name ="jumlah buku" id = "jumlah_buku" placeholder="Jumlah">
							</div>
                          </div>
