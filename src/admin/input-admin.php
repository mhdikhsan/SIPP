                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-admin.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="user_id" type="text" id="user_id" class="form-control" placeholder="Wajib Isi" required autofocus="on" />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="fullname" class="form-control" id="Full Name" type="text" placeholder="Fullname" required />
                              </div>
                          </div>
                          <div class="form-group">
