...
if (isset($_POST['register'])) {
    ...
    $sql = "INSERT INTO admin VALUES('$nip','$username','$password','$nama','$telp','$email')";
        ...
        <div class = "bgimg">
            <div class = "container">
                ...
                <div class="panel register-panel">
                    <div class="heading bg-primaary ">
                        <span class="icon mif-list bg-violent"></span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-actions" >
                                            <input type="submit" name ="register" value = "Daftar" class="button primary rounded" >
                                            <a href = "index.html"><button type="button" class="button image-button lighten primary  rounded"> <span class="icon mif-arrow-left"></span>Kembali</button></a>
                                        </div>
                                    </td>
                                </tr>
                            </table>
